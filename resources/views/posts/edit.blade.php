            ...
            <form method="POST" action="/posts/edit/{{$post->id}}" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="input-field col s12">
                        <input placeholder="Título" type="text" class="validate" id="title" name="title" value="{{ $post->title }}">
                    </div>
                </div>

                <div class="row">
                    <div class="input-field col s12">
                        <input placeholder="Subtítulo" type="text" class="validate" id="subtitle" name="subtitle" value="{{ $post->subtitle }}">
                    </div>
                </div>
